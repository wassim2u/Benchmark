...
import torch
from transformers import  TextStreamer, AutoConfig, NllbTokenizer, AutoTokenizer, T5Tokenizer, T5TokenizerFast, T5ForConditionalGeneration, M2M100ForConditionalGeneration, NllbMoeForConditionalGeneration, SwitchTransformersForConditionalGeneration
...
class Evaluation:
    def __init__(self,model_name, evaluation_dataset, dataset_name, metrics_args, hyperparameters={}, streaming=False, src_lang="en", tgt_lang="fr"):
        ...
        if model_name in ["t5-small", "t5-base", "t5-large", "t5-3b", "t5-11b", "google/t5-v1_1-small"]: 
            ...
            CONFIG["nvme_path"] = os.path.join(CONFIG["nvme_path"], "switch-base-8")
        ...
        # if "google/switch" not in model_name:
    ...
    def set_dataset(self, dataset, dataset_name):
...
if __name__ == "__main__":
    ...
    if sweep:
        ...
        current_model_initialised = None
        for model_name in configurations_sweep["model_name"]:
